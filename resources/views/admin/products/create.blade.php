        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3>Add Product
                        <a href="{{ url('admin/products') }}" class="btn btn-sm btn-dark float-end">Back</a>
                    </h3>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ url('admin/product') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane p-3 fade show active" id="home" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" name="small_description" class="form-control" rows="2"></textarea>
                                </div>
                            ...
                            <div class="tab-pane fade p-3" id="seo" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" name="meta_title" class="form-control" rows="2"></textarea>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Small Description</label>
                                    <textarea type="text" name="meta_description" class="form-control" rows="2"></textarea>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Small Keyword</label>
                                    <textarea type="text" name="meta_keyword" class="form-control" rows="2"></textarea>
                                </div>
