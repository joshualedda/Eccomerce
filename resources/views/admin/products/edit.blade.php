                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade p-3" id="details" role="tabpanel">
                                ...
                                <div class="form-check form-check-inline mb-3 d-flex align-items-center">
                                    <input class="form-check-input me-1" type="checkbox" name="trending"
                                        {{ $product->trending ? 'checked' : '' }}>
                                    <label class="form-check-label">Trending</label>
                                </div>

                                <div class="form-check form-check-inline mb-3 d-flex align-items-center">
                                    <input class="form-check-input me-1" type="checkbox" name="status"
                                        ...
                                        <tbody>
                                            @foreach ($product->productColors as $prodColor)
                                                <tr class="prod-color-tr">
                                                    <td>{{ $prodColor->color ? $prodColor->color->name : 'No Color Available' }}
                                                    </td>
                                                    <td>
                                                        <div class="input-group mb-3" style="width: 150px">
                                                            ...
                                                            <button type="button"
                                                                class="updateProductColorBtn btn btn-success btn-sm"
                                                                value="{{ $prodColor->id }}">Update</button>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <button class="deleteProductColorBtn btn btn-danger btn-sm"
